...
<body>
    ...
    <br><br>GET Requests:<br>
    <object type="image/svg+xml" width="1100" height="650" data="gets_to_dst_ips.svg"></object>

    <br><br>POSTs:<br>
    <object type="image/svg+xml" width="1100" height="650" data="posts_to_dst_ips.svg"></object>
